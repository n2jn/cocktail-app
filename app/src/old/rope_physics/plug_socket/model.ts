...
export const INPUT_UNITS: UnitDataInfo[] = [
  {icon: isIos ? 'drop.fill' : 'water', color: COLOR_UNITS[0]},
  {
    icon: isIos ? 'flame.fill' : 'fire',
    color: COLOR_UNITS[1],
  },
  {
    icon: isIos ? 'bolt.fill' : 'lightning-bolt',
    color: COLOR_UNITS[2],
  },
];
...
export const OUTPUT_UNITS: UnitDataInfo[] = [
  {
    icon: isIos ? 'lightbulb' : 'lightbulb-outline', // lightbulb.2.fill, iOS 16+
    color: UNPLUG_COLORS,
    activeIcon: isIos ? 'lightbulb.fill' : 'lightbulb',
  },
  {
    icon: isIos ? 'flashlight.off.fill' : 'flashlight-off', // spigot.fill, iOS 16+
    color: UNPLUG_COLORS,
    activeIcon: isIos ? 'flashlight.on.fill' : 'flashlight',
  },
  {
    icon: isIos ? 'printer' : 'printer-outline', // stove.fill, iOS 16+
    color: UNPLUG_COLORS,
    activeIcon: isIos ? 'printer.fill' : 'printer',
  },
];
